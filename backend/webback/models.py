...
class Ville(models.Model):
    codePostal=models.AutoField(primary_key=True)
...
class Client(models.Model):
    ...
    numCodePostal=models.ForeignKey(
        Ville,
        related_name='villes',
        on_delete=models.CASCADE,
        db_column='codePostal',
        null=True
...
class AvisExcpedition(models.Model):
    ...
    dateLivraison = models.DateTimeField(default=timezone.now)
